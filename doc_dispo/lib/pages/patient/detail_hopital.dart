                ...
                child: Row(
                  ...
                  children: [
                    Container(
                        ...
                        child: Padding(
                            padding: const EdgeInsets.all(10),
                            child: Image.asset('images/hopitaux/'+widget.hopital!.img_1)
                        )
                    ),
                    Column(
                      children: [
              ...
              SizedBox(
                ...
                child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      List<Specialite?> listSpe = getAllSpecialiteMedecins(id: widget.listMedecin![index]!.id);
                      String title = widget.listMedecin![index]!.type_medecin + " "+ widget.listMedecin![index]!.nom +" "+ widget.listMedecin![index]!.prenom;

                      return cardElementMedecin(title: title, subtitle: listSpe, size: size, image: "images/medecins/"+widget.listMedecin![index]!.img_1);
                    }),
              ),
              const Padding(
                padding: EdgeInsets.only(left: 20),
                ...
                child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return Container(
                        ...
                        child: Center(
                          child: Text(widget.listAssurance![index].nom, style: const TextStyle(fontWeight: FontWeight.bold)),
                        ),
                      );
