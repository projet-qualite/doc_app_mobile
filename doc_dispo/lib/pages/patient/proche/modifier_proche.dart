...
class ModifierProcheState extends State<ModifierProche> {
  ...
  void initState() {
    ...
    controller_mail.text = widget.proche.email;
                            ...
                            onTap: () {
                              if (_formKey.currentState!.validate()) {
                                ...
                                if(val != "")
                                  {
                                    setState(() {
                                      list_proche[widget.proche.id] = Proche(
                                          id: widget.proche.id, slug: controller_nom.text, nom: controller_nom.text, prenom: controller_prenom.text, email: controller_mail.text,
