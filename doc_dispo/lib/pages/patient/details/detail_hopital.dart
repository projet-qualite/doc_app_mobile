                    ...
                    child: Row(
                      ...
                      children: [
                        Container(
                            ...
                            child: Padding(
                                padding: const EdgeInsets.all(10),
                                child: Image.asset('images/hopitaux/'+widget.hopital!.img)
                            )
                        ),
                        Column(
                          children: [
                  ...
                  child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return InkWell(
                          ...
                          child: cardElementMedecin(title: title, subtitle: listSpe, size: size, image: "images/medecins/"+widget.listMedecin![index]!.img_1),
                        );
                      }),
                ),
                const Padding(
